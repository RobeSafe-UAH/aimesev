...
/**
 * The CustomEfficientWeighting allows adjusting the edge weights relative to those we'd obtain for a given base flag encoder.
 * For example a car flag encoder already provides speeds and access flags for every edge depending on certain edge
 * properties. By default the CustomEfficientWeighting simply makes use of these values, but it is possible to adjust them by
 ...
 * <p>
 * Instead of letting you set the speed directly, `CustomEfficientWeighting` allows changing the speed relative to the speed we
 ...
 */
public final class CustomEfficientWeighting implements Weighting {
    public static final String NAME = "efficient";
    ...
    public CustomEfficientWeighting(TurnCostProvider turnCostProvider, Parameters parameters) {
